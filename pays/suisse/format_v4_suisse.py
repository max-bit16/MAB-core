"""
Post-traitement mise en page v4 — MAB Suisse
Source  : pays/suisse/outputs/MAB_Suisse_Etude.docx
         pays/suisse/outputs/MAB_Suisse_Annexes.docx
Cible   : pays/suisse/outputs/MAB_Suisse_EtudeV4_mise_en_page.docx
         pays/suisse/outputs/MAB_Suisse_AnnexesV4.docx
...
Changements appliqués (contenu inchangé) :
  ...
  6. Saut de page obligatoire avant chaque PARTIE X / ANNEXE X
"""
import os
